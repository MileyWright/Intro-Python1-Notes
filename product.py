...
class Equipment(Product):
    def __init__(self, name, price, weight, sport):
        ...
        self.sport = sport
    def __str__(self):
        return f"A {self.sport} {self.name} costs ${self.price} dollars and weighs {self.weight} pounds"
...
class Clothing(Product):
    def __init__(self, name, price, material, color):
        ...
        self.color = color
    def __str__(self):
        return f" A {self.color} {self.material} {self.name} that costs ${self.price} dollars"
